...
import { FarmTaskType, getFarmTaskTypeColor, getFarmTaskTypeLabel } from '../../types/FarmTaskType';
...
import { type CompleteWeaningTaskFormFields, type CompleteOffspringSeparationTaskFormFields } from '../../schemas/taskSchemas';

interface TaskCardProps {
    task: TaskData;
    onCompleteTask?: (taskId: number, newCageId?: number, otherCageId?: number, femaleOffspringCount?: number) => Promise<void>;
}
...
const TaskCard: React.FC<TaskCardProps> = ({ task, onCompleteTask }) => {
    ...
    const handleCompleteWeaningTask = async (data: CompleteWeaningTaskFormFields) => {
        setWeaningError(null);
        try {
            if (onCompleteTask) {
    ...
    const handleCompleteOffspringSeparationTask = async (data: CompleteOffspringSeparationTaskFormFields) => {
        setSeparationError(null);
        try {
            if (onCompleteTask) {
    ...
    return (
        <>
            ...
            {/* Modal for offspring separation tasks */}
