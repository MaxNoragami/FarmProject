...
export class TaskService {
  ...
  static async getTasks(
    request: TaskListRequest & TaskListFilters
  ): Promise<PaginatedResponse<ApiTaskDto>> {
    ...
    if (typeof request.farmTaskType === "number")
      params.append("FarmTaskType", request.farmTaskType.toString());
