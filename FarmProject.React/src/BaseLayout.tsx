                    ...
                    <ListItem key={"tasks"} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton 
                            sx={{ 
                                ...
                                backgroundColor: location.pathname === '/tasks' ? 'rgba(0, 0, 0, 0.04)' : 'transparent'
                            }}
                        ...
                        >
                            <ListItemIcon sx={{ 
                                minWidth: 0, 
                                justifyContent: 'center',
                                color: location.pathname === '/tasks' ? 'primary.main' : 'grey.600'
                            }}>
                                <Assignment />
                            </ListItemIcon>
                        </ListItemButton>
                    ...
                    <ListItem key={"rabbits"} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton 
                            sx={{ 
                                ...
                                px: 1, 
                                justifyContent: 'center',
                                backgroundColor: location.pathname === '/rabbits' ? 'rgba(0, 0, 0, 0.04)' : 'transparent'
                            }}
                        ...
                        >
                            <ListItemIcon sx={{ 
                                minWidth: 0, 
                                justifyContent: 'center',
                                color: location.pathname === '/rabbits' ? 'primary.main' : 'grey.600'
                            }}>
                                <CrueltyFree />
                            </ListItemIcon>
                        </ListItemButton>
                    ...
                    <ListItem key={"cages"} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton 
                            sx={{ 
                                ...
                                px: 1, 
                                justifyContent: 'center',
                                backgroundColor: location.pathname === '/cages' ? 'rgba(0, 0, 0, 0.04)' : 'transparent'
                            }}
                        ...
                        >
                            <ListItemIcon sx={{ 
                                minWidth: 0, 
                                justifyContent: 'center',
                                color: location.pathname === '/cages' ? 'primary.main' : 'grey.600'
                            }}>
                                <Bento />
                            </ListItemIcon>
                        </ListItemButton>
                    ...
                    <ListItem key={"pairs"} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton 
                            sx={{ 
                                ...
                                px: 1, 
                                justifyContent: 'center',
                                backgroundColor: location.pathname === '/pairs' ? 'rgba(0, 0, 0, 0.04)' : 'transparent'
                            }}
                        ...
                        >
                            <ListItemIcon sx={{ 
                                minWidth: 0, 
                                justifyContent: 'center',
                                color: location.pathname === '/pairs' ? 'primary.main' : 'grey.600'
                            }}>
                                <Favorite />
                            </ListItemIcon>
                        </ListItemButton>
